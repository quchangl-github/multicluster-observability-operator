### Generated logs from GitHub Action: [34590980713](https://github.com/quchangl-github/multicluster-observability-operator/actions/runs/34590980713)
...
- go: downloading sigs.k8s.io/apiserver-network-proxy v0.36.0
...
- go: downloading k8s.io/kms v0.37.0
...
- go: downloading google.golang.org/genproto/googleapis/api v0.0.0-20260908043556-f8649ddbbfe6
...
- go: all: module k8s.io/api@upgrade found (v0.37.0), but does not contain package k8s.io/api/resource/v1alpha2
...
- go: all: module k8s.io/apiserver@upgrade found (v0.37.0), but does not contain package k8s.io/apiserver/pkg/admission/plugin/webhook/config/apis/webhookadmission/v1alpha1
...
- go: all: module k8s.io/client-go@upgrade found (v0.37.0), but does not contain package k8s.io/client-go/applyconfigurations/resource/v1alpha2
...
- go: all: module k8s.io/client-go@upgrade found (v0.37.0), but does not contain package k8s.io/client-go/informers/resource/v1alpha2
...
- go: all: module k8s.io/client-go@upgrade found (v0.37.0), but does not contain package k8s.io/client-go/kubernetes/typed/resource/v1alpha2
- go: all: module k8s.io/client-go@upgrade found (v0.37.0), but does not contain package k8s.io/client-go/kubernetes/typed/resource/v1alpha2/fake
...
- go: all: module k8s.io/client-go@upgrade found (v0.37.0), but does not contain package k8s.io/client-go/listers/resource/v1alpha2
